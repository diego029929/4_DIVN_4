      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-4 pb-16">
        ...
        <ProductCard
          product={{
            ...
            description: "Casquette premium avec logo DIVN brodé",
            priceInCents: 3900,
            images: [
              "https://via.placeholder.com/300x300?text=Produit+4A"
            ],
            inStock: true,
        ...
        <ProductCard
          product={{
            ...
            description: "T-shirt en coton premium avec une coupe moderne",
            priceInCents: 4900,
            images: [
              "https://via.placeholder.com/300x300?text=Produit+5A"
            ],
            inStock: true,
            category: "homme",
          }}
