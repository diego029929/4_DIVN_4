  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto space-y-12 prose prose-invert text-muted-foreground">
          ...
          <section>
            ...
            <ul className="space-y-3">
              <li className="leading-relaxed">
                <strong className="text-foreground">Qualité Premium:</strong> Nous sélectionnons uniquement les meilleurs
                matériaux et travaillons avec des artisans qualifiés.
              </li>
              <li className="leading-relaxed">
